...
const DecoLine = ({ wide = false }: { wide?: boolean }) => (
  ...
  const CountdownBox = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center">
      <div className="w-16 h-16 border border-[#E81E62]/90 rounded-sm flex items-center justify-center bg-background/40 backdrop-blur-sm">
  ...
  const Index = () => {
    ...
    const whatsappLink = "https://wa.me/5493586540512?text=Holaaa, %20Confirmo%20asistencia%20a%20los%20XV%20de%20Angelina"; // ← Editar número y mensaje
